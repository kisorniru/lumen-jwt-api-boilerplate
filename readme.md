...
[![JWT Auth](https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/JWT-Logo.svg/800px-JWT-Logo.svg.png)](https://jwt-auth.readthedocs.io/en/develop/lumen-installation/)
...
Documentation for the JWT can be found on the [JWT and Lumen](https://jwt-auth.readthedocs.io/en/develop/lumen-installation/).
